    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            }).AddJwtBearer(o =>
            {
                ...
                //Событие, сообщающее, что истек срок у токена доступа
            ...
            services.AddScoped<ITokenServiceInteractor, TokenServiceInteractor>();
            services.AddSingleton<IGetCoursesInteractor<DateCourses, CurrencyCourse>, CourseDBInteractor>();
